...
const CourseDetail = () => {
  ...
  if (isError)
    return <h2>Failed to load course details. Please try again later.</h2>;
        ...
        <div className="w-full lg:w-1/3">
          <Card>
            <CardContent className="p-4 flex flex-col">
              ...
              {/* <h1>{course.lectures.lectureTitl}lechter title</h1>
              <Separator className="my-2" />
              <h1 className="text-lg md:text-xl font-semibold">Course Price</h1> */}
              <h1>{course?.courseTitle || "No lecture available"}</h1>
              <Separator className="my-2" />
